...
public class CentralPacientes {
    ...
    public int cantHombres() {
        ...
        int contadorH = 0;
        Paciente pac = primero;

        while(pac!=null){
            if (pac.darSexo() == 1){
                contadorH++;
            }
            pac = pac.darSiguiente();
        }
    ...
    /**
     * Método para la extensión4 = Retorna el nombre del paciente que tenga el mayor código
     *
     * @return respuesta4
     */
    public String metodo4() {

        int codigo_mayor = Integer.MIN_VALUE;
        String nombrePacienteCodigoMayor = "";
        Paciente pac = primero;

        while (pac!=null){
            if(pac.darCodigo()>codigo_mayor){
                codigo_mayor = pac.darCodigo();
                nombrePacienteCodigoMayor = pac.darNombre();
            }
            pac = pac.darSiguiente();
        }

        return nombrePacienteCodigoMayor;
    }
